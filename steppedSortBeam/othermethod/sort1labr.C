                ...
                if ((data & 0xc0000000) == 0xc0000000)
                {
                    ...
                    */
                    ...
                    if ((ident > 63) && (ident < 68)) 
                    {
                        ...
                        if ((slowECalibL[detectorID].size() == 0)&&(timeS[detectorID].size() == 0))
                        {
                            slowECalibL[detectorID].push_back(energycalib);
                            timeS[detectorID].push_back(TS); // time in 1e12s which is 10ns
