...
int main (int argc, char** argv)
{
  ...
  int energyF[4] = {-1,-1,-1,-1,-1,-1,-1,-1,-1};
  int energyS[4] = {-1,-1,-1,-1,-1,-1,-1,-1,-1};
  double Time[4] = {-1,-1,-1,-1,-1,-1,-1,-1,-1}; 
  double Td;
  ...
  for (j = 1; j <=8; j++)
    {
	  ...
	  k5[j] = new TH1D(TString::Format("Time_RF_%02d", j),"Spectrum",16384,0,16383);
