...
ax[0].set_title('E$_{1}$ vs $\\theta_{1}$', fontsize = 30)
...
ax[1].set_xlim(0, 180)
ax[1].set_ylim(0, 600)
ax[1].set_title('E$_{1}$ vs $\\theta_{1}$ - CLF applied', fontsize = 30)
...
plt.ylim(0, 6000)
plt.grid(True, which='both', axis='both', linestyle='--', linewidth=0.5)
plt.xlabel('$\\theta_{1}$ (deg)', fontsize = 30)
plt.ylabel('Energy (keV)', fontsize = 30)
plt.title('E$_{1}$ vs $\\theta_{1}$ ', fontsize = 30)
plt.tick_params(axis='both', which='major', labelsize=20)
...
plt.ylabel('Energy  (keV)', fontsize = 30)
plt.xlabel('$\\theta_{1}$ (deg)', fontsize = 30)
plt.title('E$_{0}$ vs $\\theta_{1}$', fontsize = 30)
plt.tick_params(axis='both', which='major', labelsize=20)
cbar = plt.colorbar()
plt.grid(axis='both', alpha=0.5, linestyle='--', linewidth=0.5)
